...
title = TutaAbsolutaApp

# (str) Package name
package.name = TutaApp
...
# (str) welcome of the application
welcome.filename = %(source.dir)s/images/welcome.jpg

# (str) Icon of the application
#icon.filename = %(source.dir)s/images/welcome.jpg
